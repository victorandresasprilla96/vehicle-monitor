...
- **Seguimiento de cámara**: `panTo` con `easeLinearity: 1/3` (equivale a *ease-out cubic*, la misma curva que el marcador), así que el vehículo se mantiene centrado (medido: desviación ≤ 0.9 px). Arrastrar el mapa o moverlo con las flechas desactiva el seguimiento. Se reactiva desde tres sitios que comparten un único estado: el interruptor **"Seguir vehículo"** de la tarjeta (`role="switch"`), la pastilla inferior ("Siguiendo a Camión 02 · Dejar de seguir") y el botón **"Centrar en el vehículo"** junto al zoom. La cámara centra el vehículo en la **zona visible**, a la derecha de la tarjeta flotante o por encima de la hoja inferior.
